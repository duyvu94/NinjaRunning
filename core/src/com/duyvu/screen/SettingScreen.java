...
public class SettingScreen implements Screen, InputProcessor {
	...
	public SettingScreen(Game myGame) {
		...
		musicOnButton = new SimpleButton(gameWidth/2-100, 180, 200, 45, AssetLoader.musicOnButtonUp, AssetLoader.musicOnButtonDown);
		musicOffButton = new SimpleButton(gameWidth/2-100, 180, 200, 45, AssetLoader.musicOffButtonUp, AssetLoader.musicOffButtonDown);
		soundOnButton = new SimpleButton(gameWidth/2-100, 250, 200, 45, AssetLoader.soundOnButtonUp, AssetLoader.soundOnButtonDown);
		soundOffButton = new SimpleButton(gameWidth/2-100, 250, 200, 45, AssetLoader.soundOffButtonUp,
				AssetLoader.soundOffButtonDown);
		backButton = new SimpleButton(gameWidth/2-100, 320, 200, 45, AssetLoader.backButtonUp, AssetLoader.backButtonDown);
	...
	public void render(float delta) {
		...
		batcher.draw(AssetLoader.menuScreen, 0, 0, gameWidth, gameHeight);
