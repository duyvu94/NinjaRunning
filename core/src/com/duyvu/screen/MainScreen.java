...
public class MainScreen implements Screen, InputProcessor {
	...
	public MainScreen(Game myGame) {
		...
		startButton = new SimpleButton(gameWidth/2-100, 180, 200, 45, AssetLoader.startButtonUp, AssetLoader.startButtonDown);
		settingButton = new SimpleButton(gameWidth/2-100, 250, 200, 45, AssetLoader.settingButtonUp, AssetLoader.settingButtonDown);
		helpButton = new SimpleButton(gameWidth/2-100, 320, 200, 45, AssetLoader.helpButtonUp, AssetLoader.helpButtonDown);
