...
public class FishSpaceship extends Monster {
	...
	public FishSpaceship(float width, float height){
		super(width, height);
	...
	public void draw(SpriteBatch batcher){
		if (isExploded()){
			...
			batcher.draw(AssetLoader.fishSpaceship, position.x, position.y, sizeofShip.x, sizeofShip.y);
		}
